...
namespace AccountingApp.Forms
{
    public partial class AddEditPurchaseForm : Form
    {
        ...
        private void CalculateTotals(object? sender = null, EventArgs? e = null)
        {
            ...
            var totalDiscount = _purchaseItems.Sum(item => item.DiscountAmount) + _numDiscountAmount!.Value;
        ...
        private void BtnSave_Click(object? sender, EventArgs e)
        {
            try
            {
                if (ValidateInput())
                {
                    ...
                    purchase.FinalAmount = purchase.TotalAmount - purchase.DiscountAmount + purchase.TaxAmount;
